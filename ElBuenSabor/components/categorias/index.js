    ...
    var dataProvider = app.data.elBuenSabor,
        ...
        categoriasModel = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || categoriasModel.originalItem;

                app.mobileApp.navigate('#components/categorias/details.html?uid=' + dataItem.uid);

            },
            detailsShow: function(e) {
                categoriasModel.setCurrentItemByUid(e.view.params.uid);
            },
            setCurrentItemByUid: function(uid) {
                ...
                categoriasModel.set('originalItem', itemModel);
                categoriasModel.set('currentItem',
                    categoriasModel.fixHierarchicalData(itemModel));
