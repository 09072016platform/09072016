    ...
    var dataProvider = app.data.elBuenSabor,
        ...
        ordenesModel = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || ordenesModel.originalItem;
            ...
            detailsShow: function(e) {
                ordenesModel.setCurrentItemByUid(e.view.params.uid);
            },
            setCurrentItemByUid: function(uid) {
                ...
                ordenesModel.set('originalItem', itemModel);
                ordenesModel.set('currentItem',
                    ordenesModel.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            var itemUid = e.view.params.uid,
                ...
                fixedData = ordenesModel.fixHierarchicalData(itemData);
